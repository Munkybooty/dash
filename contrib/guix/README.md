...
- 24GB of free disk space on the partition that the Dash Core git repository
  resides in
...
For a Dash Core depends development environment, simply invoke
...
From the top of a clean Dash Core repository:
...
To use dongcarl's substitute server for Dash Core builds after having
