...
(define* (make-dash-cross-toolchain target
                                  #:key
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-dash-cross-toolchain "i686-linux-gnu")
       (make-dash-cross-toolchain "x86_64-linux-gnu")
       (make-dash-cross-toolchain "aarch64-linux-gnu")
       (make-dash-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-dash-cross-toolchain "riscv64-linux-gnu"
